...
\begin{figure}[H]
    ...
    \caption[Words usage compared to success rate]{Words usage compared to success rate\footnotemark}
...
\begin{figure}[H]
    ...
    \caption{Success rate for Countries}
...
\begin{figure}[H]
    ...
    \caption{Distribution of major countries success rate compared to all countries}
